...
def main():
    ...
    # Create data loaders
    train_dataloader = DataLoader(AngleDataset(x_data[:split_idx], y_data[:split_idx]), batch_size=batch_size, shuffle=True, num_workers=4)
    val_dataloader = DataLoader(AngleDataset(x_data[split_idx:], y_data[split_idx:]), batch_size=batch_size, num_workers=4)
